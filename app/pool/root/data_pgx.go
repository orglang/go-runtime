...
import (
	...
	proc "smecalculus/rolevod/app/proc/root"
)
...
func (r *repoPgx) Insert(source data.Source, root impl) (err error) {
...
func (r *repoPgx) SelectSubs(source data.Source, poolID id.ADT) (Snap, error) {
	ds := data.MustConform[data.SourcePgx](source)
