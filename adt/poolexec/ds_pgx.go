...
func (r *daoPgx) SelectProc(source sd.Source, procID identity.ADT) (procexec.Cfg, error) {
	ds := sd.MustConform[sd.SourcePgx](source)
...
func (r *daoPgx) SelectSubs(source sd.Source, poolID identity.ADT) (PoolSnap, error) {
	ds := sd.MustConform[sd.SourcePgx](source)
